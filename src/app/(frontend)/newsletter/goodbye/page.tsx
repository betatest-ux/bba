...
export default function Page() {
  return (
    <div className="container flex min-h-[50vh] flex-col items-center justify-center py-24 text-center">
      ...
      <h1 className="font-display text-h1">You’re unsubscribed — no hard feelings</h1>
      <p className="mt-4 max-w-md text-lg text-muted-foreground">Your details have been removed. If you change your mind, you can sign up again from the footer of any page.</p>
      <Link
